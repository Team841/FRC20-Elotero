...
private WPI_TalonFX shootRight;
private WPI_TalonFX shootLeft;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    public DriveTrain() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
left1 = new WPI_TalonFX(3);
...
right1 = new WPI_TalonFX(1);


        
right2 = new WPI_TalonFX(2);

shootRight = new WPI_TalonFX(5);
shootLeft = new WPI_TalonFX(6);

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

left2.follow(left1);   //Set one motor to "follow" each side
...
//this is where our vision update code would go
    }
